...
export default function SeasonRecord({
    ...
    const tiePct = ties !== undefined
        ? ((ties / total) * 100).toFixed(1)
        : undefined;
    ...
    return (
        <div className="season-record" ref={containerRef}>
            ...
            <div className="group">
                ...
                <div className="bar">
                    <div
                        className="fill fill--loss"
                        style={{ width: inView ? `${lossPct}%` : '0%' }}
                    />
                </div>
            </div>
            ...
            {ties !== undefined && (
                <div className="group">
                    <div className="labels">
                        <span>Ties</span>
                        <span>{ties} ({tiePct}%)</span>
                    </div>
                    <div className="bar">
                        <div
                            className="fill fill--tie"
                            style={{ width: inView ? `${tiePct}%` : '0%' }}
                        />
                    </div>
                </div>
            )}
