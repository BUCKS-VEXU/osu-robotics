...
export const events: Array<Event> = [
  {
    ...
    description:
      "In leu of an On-Campus space to work, BUCKS held it's first build meeting in Sage's basement. Here we started work on the pair of robots that we would take the Riverbots only a month later.",
  ...
  },
  {
    ...
    description:
      'After months of searching, BUCKS was granted a space on the fifth floor of the Smith Laboratory at The Ohio State University. We immediately took our things from the dungeon and relocated to our new home.',
